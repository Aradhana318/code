...
with open(r"C:\Users\ANKIT\Desktop\Aradhana\Association Rules\my_movies.csv") as f:my_movies = f.read()
...
my_movies_series = my_movies_series.iloc[:9835,:] # removing the last empty transaction
